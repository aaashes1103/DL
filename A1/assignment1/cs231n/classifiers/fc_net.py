    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers):
            ...
            if self.normalization == 'batchnorm':
                ...
                out, cache_af = affine_forward(out, W, b)
                ...
                out, cache_rl = relu_forward(out)
                cache = (cache_af, cache_ln, cache_rl)
            else:
        ...
        # The last layer (without ReLU / dropout / normalization)
        ...
        # Backward pass for the layer 1 to L-1
        for i in range(self.num_layers - 1, 0, -1):
            ...
            if self.normalization == 'batchnorm':
                ...
                cache_af, cache_ln, cache_rl = cache
                dout = relu_backward(dout, cache_rl)
