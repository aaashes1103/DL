...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # The output size after conv layer
        conv_out_h = H  # preserved
        conv_out_w = W  # preserved
        # The output size after 2x2 max pool layer
        pool_out_h = conv_out_h // 2
        pool_out_w = conv_out_w // 2
        # The first affine layer
        self.params["W2"] = np.random.randn(
            num_filters * pool_out_h * pool_out_w, hidden_dim
        ) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        # Backward pass
        daff1_out, dW3, db3 = affine_backward(dscores, aff2_cache)
        dconv_out, dW2, db2 = affine_relu_backward(daff1_out, aff1_cache)
